        ...
        <Flex className={style.div} direction={"column"}  width={"100%"} height={"120vh"}>
            ...
            <Flex className={style["login-div"]} width={"70%"} height={"80vh"}>
                ...
                <Flex width={"50%"} direction={"column"} height={"50%"} className={style["login-div__inputs"]}>
                    <Input input={{placeholder:"Usuario", onChange:usernameValueChangeHandler}}></Input>
                    <Input input={{placeholder:"Contraseña", onChange:passwordValueChangeHandler, type:"password"}}></Input>
                    <button className={style["login-div__button"]}>INGRESAR</button>
